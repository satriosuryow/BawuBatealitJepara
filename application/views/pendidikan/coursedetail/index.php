      ...
      <div class="container">
        <div class="row">
          <div class="col-md-7 col-xl-8">
            <img class="img-fluid  mb-4" src="<?php echo base_url(); ?>images/course/10.jpg" alt="">
            ...
            <ul class="list-unstyled d-flex flex-wrap mb-5">
              <li class="course-d-Teacher mr-3 mr-lg-5 mb-2 mb-lg-0">
                <div class="d-flex">
                  <img class="mr-2 mr-lg-3 mt-2" src="<?php echo base_url(); ?>images/avatar/11.jpg" alt="">
                  <div class="d-block">
            ...
            <div class="border mb-4">
              ...
              <div class="p-4 border-top">
                ...
                <div class="progress-item mb-2">
                  ...
                  <div class="progress rounded" style="height: 6px;">
                    <div class="progress-bar bg-warning rounded" role="progressbar" style="width: 67%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                  </div>
                </div>
                <div class="progress-item mb-2">
                  <div class="d-flex">
                  ...
                  <div class="progress rounded" style="height: 6px;">
                    <div class="progress-bar bg-warning rounded" role="progressbar" style="width: 32%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                  </div>
                </div>
                <div class="progress-item">
                  ...
                  <div class="progress rounded" style="height: 6px;">
                    <div class="progress-bar bg-warning rounded" role="progressbar" style="width: 10%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                  </div>
                </div>
              </div>
            </div>
            <div class="border mb-4">
              ...
              <div class="p-4 border-top">
                <div class="mb-4 d-xl-inline-flex">
                  <img class="mr-3 media-img" src="<?php echo base_url(); ?>images/avatar/06.jpg" alt="">
                ...
                <div class="d-xl-inline-flex mt-4 mb-4">
                  <img class="mr-3 media-img" src="<?php echo base_url(); ?>images/avatar/11.jpg" alt="">
                  <div class="media-body">
                    <div class="px-xl-4 mt-3 mt-xl-0">
                      <div class="d-flex align-items-center">
                ...
                <div class="d-xl-inline-flex">
                  <img class="mr-3 media-img" src="<?php echo base_url(); ?>images/avatar/05.jpg" alt="">
                  <div class="media-body">
                    <div class="px-xl-4 mt-3 mt-xl-0">
                      <div class="d-flex align-items-center">
            ...
            <div class="widgets">
              ...
              <div class="widget widget-course-instructor">
                ...
                <div class="widget-content">
                  <div class="row">
                    <div class="col-sm-4">
                      <img class="rounded-circle img-fluid mb-2" src="<?php echo base_url(); ?>images/avatar/04.jpg" alt="">
                    </div>
                  </div>
